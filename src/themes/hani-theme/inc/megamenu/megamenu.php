...
class hani_MegaMenu{
    ...
    {
        add_action('wp_nav_menu_item_custom_fields' , [$this , 'hani_mega_menu_add_custom_fields'] ,10 , 5);
        add_action('wp_update_nav_menu_item' ,[$this ,'hani_mega_menu_update_custom_fields'],10 ,3 );
        add_action('wp_setup_nav_menu_item' , [$this ,'hani_mega_menu_setup_nav_fields']);
    }

    public function hani_mega_menu_setup_nav_fields($menu_item){
    ...
    public function hani_mega_menu_update_custom_fields($menu_id, $menu_item_db_id) {
    ...
    public function hani_mega_menu_add_custom_fields($item_id , $item , $depth , $args){
        ?>
